...
if [ ! -f "/home/pi/bin/piPowerTempLog/README.md" ]; then
  printf "\n\n Installing piHeatingHub-extended-log ...\n"

  cd /home/pi
  
  if [ -d "/home/pi/bin/piPowerTempLog" ]; then
  	printf "\n\n Deleting old install ...\n"
    rm -rf "/home/pi/bin/piPowerTempLog"
  fi

  printf "\n\n Copying new installation ...\n"
  cp -r "/home/pi/bin/pi-heating/piPowerTempLog/piPowerTempLog" "/home/pi/"
  printf "\n\n Moving www files ...\n"
  mv "/home/pi/bin/piPowerTempLog/www" "/var/www/piPowerTempLog"
  
  printf "\n\n Setting permission ...\n"
  chown -R pi:pi "/home/pi/bin/piPowerTempLog"
  chmod -R 750 "/home/pi/bin/piPowerTempLog"
...
MAILTO=""
*/2 * * * * pi /bin/bash /home/pi/bin/piPowerTempLog/cron/wrapper.sh >> /dev/null 2>&1
CRON
	printf "\n\n Restarting cron ...\n"
